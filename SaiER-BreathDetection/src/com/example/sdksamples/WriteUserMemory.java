...
//            }
            ...
            seq.setExecutionCount((short) 1); // 设置执行次数
            ...
            writeOp.setData(TagData.fromHexString("666666666"));
            ...
            String targetEpc = "E2004074870202400870C322";
//            if (targetEpc != null) {
